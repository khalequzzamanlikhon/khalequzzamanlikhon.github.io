...
const entities = [
  ...
  },
  {
    ...
    summary: `Overcooked AAR asks what a model misses when it reads logs instead of watching. I take real two-player Overcooked trials and generate after-action reviews two ways: an LLM reads a natural-language event timeline, and a vision-language model watches the rendered gameplay video.`,
    detail: `Blind human ratings show where the two diverge. Telemetry knows exactly what happened but not what it looked like; video catches hesitation, near-misses, and blocked attempts that never become logged events. One lesson: the quality of event extraction mattered more than the prompts.`,
    tech: ['Qwen2.5-VL', 'LLMs via Groq and Gemini', 'the overcooked-ai StateVisualizer', 'blind human rating'],
...
const topics = [
  ...
  { id: 'research',
    ...
    reply: `My research interests are computer vision, real-time video understanding, large language models, generative AI, multimodal learning, and human-centered computing. What connects them is reliability: how models behave under real-world shift, when they should abstain, and whether their outputs stay grounded in evidence.`,
  ...
  { id: 'projects',
    ...
    reply: `Some favourites: Sentinel (video anomaly detection), DocuRoute (agentic retrieval over financial filings), Research→Code (multi-agent code synthesis), DepthCraft (measurable 3D from one image), and Overcooked AAR (what LLMs miss reading logs vs. watching video). There's also SentinelRAG, voice-dub, and a Phone Support Agent. Ask about any of them by name!`,
